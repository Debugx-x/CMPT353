# -*- coding: utf-8 -*-
"""
Created on Fri Jul  9 19:44:20 2021
...
def main():
    ...
    # build/train bayes_rgb_model to predict using Nearest neighbour classifer
    knn_rgb_model = KNeighborsClassifier(n_neighbors=10)
    knn_rgb_model.fit(X_train, y_train)
    
    # build/train bayes_rgb_model to predict by converting to LAB colour first then Nearest neighbour classifer
    ...
    # build/train bayes_rgb_model to predict using Random Forest classifer
